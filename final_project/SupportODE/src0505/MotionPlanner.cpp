...
//initialize your data structures/variables here
	...
	{for (int j=0;j<NCell;j++)
	  {m_config_grid[i][j] = new int[NAngle];} // dimension of orientation = 1 temporarily
	}
...
while (m_vidGoal!=1)
{
 ...
 if ( m_config_grid[qxI][qyI][0]==0 && m_vidGoal!= 1)
  {
     //printf("m_config_grid[qxI][qyI][0]= %d ", m_config_grid[qxI][qyI][0]);


     m_config_grid[qxI][qyI][0]=1;
